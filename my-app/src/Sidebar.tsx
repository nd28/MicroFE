...
export default function Sidebar({ children, toggleButtonClick }) {
  ...
  return (
    <>
      ...
      <div>
        <div className="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
          ...
          <div
            x-ref="loading"
            className="hidden fixed inset-0 z-50 flex items-center justify-center text-2xl font-semibold text-white bg-indigo-800"
          >
            Loading.....
          </div>
          {/* Sidebar */}
    ...
    ></div> */}
            ...
            <div
              x-show="isSidebarOpen"
              className="fixed inset-y-0 z-10 w-16 bg-white"
            />
            {/* Mobile bottom bar */}
            <nav
              aria-label="Options"
            ...
            >
              ...
              <button
                onClick={() => {
                  let { isSidebarOpen, currentSidebarTab } = state;
                ...
                className={`p-2 transition-colors rounded-lg shadow-md hover:bg-indigo-800 hover:text-white focus:outline-none focus:ring focus:ring-indigo-600 focus:ring-offset-white focus:ring-offset-2 ${(() =>
                  state.isSidebarOpen && state.currentSidebarTab == "linksTab"
            ...
            {/* x-transition:leave-end="-translate-x-full" */}
            {
              <div
                x-show="isSidebarOpen"
                className="hidden fixed inset-y-0 left-0 z-10 flex-shrink-0 w-64 bg-white border-r-2 border-indigo-100 shadow-lg sm:left-16 rounded-tr-3xl rounded-br-3xl sm:w-72 lg:static lg:w-64"
              >
                <nav
                  ...
                  <div className="flex-shrink-0 p-4 mt-10">
                    <div className="hidden p-2 space-y-6 bg-gray-100 rounded-lg md:block">
                      ...
                      <p className="text-sm text-indigo-600">
                        Use our{" "}
                        <span className="text-base text-indigo-700er">
                          Premium
                        </span>{" "}
                        features now! <br />
                      </p>
          ...
          <div className="flex flex-col flex-1">
            <header className="relative flex items-center justify-between flex-shrink-0 p-4">
              ...
              <div className="items-center hidden ml-4 sm:flex">
                ...
                <button className="p-2 mr-4 text-gray-400 bg-white rounded-lg shadow-md hover:text-gray-600 focus:outline-none focus:ring focus:ring-white focus:ring-offset-gray-100 focus:ring-offset-4">
              ...
              <button className="p-2 text-gray-400 bg-white rounded-lg shadow-md sm:hidden hover:text-gray-600 focus:outline-none focus:ring focus:ring-white focus:ring-offset-gray-100 focus:ring-offset-4">
              ...
              >
                ...
                <button className="p-2 text-gray-400 bg-white rounded-lg shadow-md hover:text-gray-600 focus:outline-none focus:ring focus:ring-white focus:ring-offset-gray-100 focus:ring-offset-4">
                  <span className="sr-only">Settings</span>
                  <svg
                    aria-hidden="true"
                    className="w-6 h-6"
        ...
        <section
          x-show="isSettingsPanelOpen"
          className="hidden fixed inset-y-0 right-0 w-64 bg-white border-l border-indigo-100 rounded-l-3xl"
        >
